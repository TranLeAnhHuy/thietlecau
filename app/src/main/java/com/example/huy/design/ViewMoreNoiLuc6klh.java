...
public class ViewMoreNoiLuc6klh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_more_noi_luc6klh);
        Intent ViewMoreNoiLuc6bundleklh = getIntent();
        // lấy dữ liệu
        M61= ViewMoreNoiLuc6bundleklh.getDoubleExtra("M61",0.0);
        M62= ViewMoreNoiLuc6bundleklh.getDoubleExtra("M62",0.0);
        M63= ViewMoreNoiLuc6bundleklh.getDoubleExtra("M63",0.0);
        M64= ViewMoreNoiLuc6bundleklh.getDoubleExtra("M64",0.0);
        Q61= ViewMoreNoiLuc6bundleklh.getDoubleExtra("Q61",0.0);
        Q62= ViewMoreNoiLuc6bundleklh.getDoubleExtra("Q62",0.0);
        Q63= ViewMoreNoiLuc6bundleklh.getDoubleExtra("Q63",0.0);
        Q64= ViewMoreNoiLuc6bundleklh.getDoubleExtra("Q64",0.0);
        Q65= ViewMoreNoiLuc6bundleklh.getDoubleExtra("Q65",0.0);
        Q66= ViewMoreNoiLuc6bundleklh.getDoubleExtra("Q66",0.0);
        Q67= ViewMoreNoiLuc6bundleklh.getDoubleExtra("Q67",0.0);
        Q68= ViewMoreNoiLuc6bundleklh.getDoubleExtra("Q68",0.0);
        Q69= ViewMoreNoiLuc6bundleklh.getDoubleExtra("Q69",0.0);
        Q610= ViewMoreNoiLuc6bundleklh.getDoubleExtra("Q610",0.0);
        //TTGH CĐ1-dầm trong
        Mval[0] = 0f;
        Mval[1] = (float)M61;
        Mval[2] = (float)M62;
