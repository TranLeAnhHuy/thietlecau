...
public class ViewMoreUngSuatGD1klh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_more_ung_suat_gd1klh);
        //Láy kết quả
        Intent ViewMoreUNGSUATGD1bundleklh = getIntent();
        // lấy dữ liệu
        f11= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f11",0.0);
        f12= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f12",0.0);
        f13= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f13",0.0);
        f14= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f14",0.0);
        f15= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f15",0.0);
        f16= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f16",0.0);
        f17= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f17",0.0);
        f18= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f18",0.0);
        f19= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f19",0.0);
        f110= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f110",0.0);
        f111= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f111",0.0);
        f112= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f112",0.0);
        f113= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f113",0.0);
        f114= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f114",0.0);
        f115= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f115",0.0);
        f116= ViewMoreUNGSUATGD1bundleklh.getDoubleExtra("f116",0.0);
